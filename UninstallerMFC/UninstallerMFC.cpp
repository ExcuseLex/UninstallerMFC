...
// UninstallerMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CUninstallerMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CUninstallerMFCApp

CUninstallerMFCApp::CUninstallerMFCApp()
{
...
// Единственный объект CUninstallerMFCApp

CUninstallerMFCApp theApp;


// Инициализация CUninstallerMFCApp

BOOL CUninstallerMFCApp::InitInstance()
{
